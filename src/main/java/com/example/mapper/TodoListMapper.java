...
public class TodoListMapper {
	...
	private final String selectList = "select id,text,checked,color,moment,image from todoList1 where useYn='Y'";
	private final String insert = "insert into todoList1 (id,text,color,image) values (?,?,?,?)";
	...
	private final String update2 = "update todoList1 set text = ? , color = ? , checked = ?, image = ? where id = ?";
